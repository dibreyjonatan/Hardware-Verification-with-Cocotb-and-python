...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , sr_in{vlSymsp->TOP.sr_in}
    , sr_out{vlSymsp->TOP.sr_out}
    , shift{vlSymsp->TOP.shift}
    , sr_tap_one{vlSymsp->TOP.sr_tap_one}
    , sr_tap_two{vlSymsp->TOP.sr_tap_two}
    , sr_tap_three{vlSymsp->TOP.sr_tap_three}
    , rootp{&(vlSymsp->TOP)}
{
